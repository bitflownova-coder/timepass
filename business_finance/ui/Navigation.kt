    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(
                ...
                /* 
                   TODO: Pass paymentId to InvoiceGeneratorScreen to pre-fill data.
                   Currently ignoring paymentId to enable the new screen.
                */
                com.bitflow.finance.ui.screens.invoice.InvoiceGeneratorScreen(
                    onBackClick = { navController.popBackStack() }
                )
            }
